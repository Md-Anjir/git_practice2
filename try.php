...
<body>
    ...
    $sql_blood_groups = "SELECT bloodGroup, SUM(amount) AS total_amount, 
    ...
    if ($result_blood_groups->num_rows > 0) {
        ...
        echo "<table>";
        echo "<tr><th>Blood Group</th><th>Total Amount</th><th>Success Rate</th></tr>";
        while($row_blood_groups = $result_blood_groups->fetch_assoc()) {
            ...
            echo "<tr><td>$blood_group</td><td>$total_amount</td><td>$success_rate%</td></tr>";
        }
        echo "</table>";
    } else {
    ...
    if ($result_locations->num_rows > 0) {
        ...
        echo "<table>";
        echo "<tr><th>Location</th><th>Total Amount</th><th>Success Rate</th></tr>";
        while($row_locations = $result_locations->fetch_assoc()) {
            ...
            $success_rate = $total_count > 0 ? round(($success_count / $total_count) * 100, 2) : 0;
            echo "<tr><td>$location</td><td>$total_amount</td><td>$success_rate%</td></tr>";
        }
        echo "</table>";
    } else {
