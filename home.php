...
<html lang="en">
  ...
  <body>
    <div class="header">
      <nav>
        <ul class="nav-upper flex-space-around">
          ...
          <li class="nav_list">
            <a href="blood_donation_form.html" class="nav_link">Request for Blood</a>
          </li>
          <li class="nav_list">
            <a href="blood_donation_requests.php" class="nav_link">See Requests</a>
          </li>
          <li class="nav_list">
            <a href="contact.html" class="nav_link">Contact</a>
          </li>
          <li class="nav_list">
            <a href="donor_profile_form.html" class="nav_link">Update Profile</a>
          </li>
          <li class="nav_list">
    ...
    <div class="content">
      <h1>Welcome to Red Drop Account, <?php echo $name; ?></h1>
